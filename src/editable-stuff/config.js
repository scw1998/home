...
const mainBody = {
  ...
  icons: [
    {
      image: "fa-github",
      url: "https://github.com/scw1998",
    },
    {
      image: "fa-linkedin",
      url: "https://www.linkedin.com/in/chiwonseuh/",
    },
  ],
};
...
const about = {
  show: true,
  heading: "About Me",
  imageLink: require("../editable-stuff/chiwon.png"),
  imageSize: 375,
  message:
...
const repos = {
  ...
  gitHubUsername: "scw1998", //i.e."johnDoe12Gh"
  reposLength: 4,
  specificRepos: [],
};
...
const leadership = {
  ...
  images: [
    { 
      img: require("../editable-stuff/chiwon.png"), 
  ...
  data: [
    {
      ...
      companylogo: require('../assets/img/uwmadison.png'),
      date: 'Sep 2024 – Present',

    },
    {
      role: 'AI Researche Intern',
      companylogo: require('../assets/img/kaist.png'),
      date: 'June 2024 – August 2024',
    },
    {
      role: 'Executive Secretary',
      companylogo: require('../assets/img/navy.png'),
      date: 'April 2021 – Dec 2022',
    },
    {
      role: "2018 Pyeongchang Winter Olympics Volunteer (Event Coordinator)",
      companylogo: require('../assets/img/olym.jpeg'),
